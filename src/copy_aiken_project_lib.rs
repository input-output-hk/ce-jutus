// //! This is directly derived from https://github.com/aiken-lang/aiken/blob/43ff66c/crates/project/src/lib.rs
// //! which is licensed as Apache-2.0: https://github.com/aiken-lang/aiken/blob/43ff66c/LICENSE
// //! The reason we cannot use it as a library from aiken is that some functions there are not public.
// //! NOTE Wherever we could use a `use` statements instead of just copying everything, we did it,
// //!      e.g. for [aiken_project::Source].
// //! TODO open a PR/issue
// //!
...
use aiken_project::module::{CERT, MINT, SPEND, VALIDATOR_NAMES, WITHDRAW};
use aiken_project::options::{CodeGenMode, Options};
use aiken_project::script::{EvalHint, EvalInfo, Script};
...
// Note(christos): use from library, since everything is public
// #[derive(Debug)]
// pub struct Source {
//     pub path: PathBuf,
//     pub name: String,
    ...
    T: EventListener,
{
    ...
    // Note(christos): Making this public
    pub fn type_check(
        &mut self,
    ...
    // Note(christos): Making this public
    pub fn eval_scripts(&self, scripts: Vec<Script>, match_name: Option<String>) -> Vec<EvalInfo> {
